                    ...
                    <form onSubmit={sendContact}>
                        ...
                        <div className="form-group inline">
                            <div className="form-group-inline">
                                ...
                                <input type="text" id="firstname" onChange={e => setFirstname(e.target.value)} name="firstname" value={firstname} />
                            </div>
                            <div className="form-group-inline">
                                <label htmlFor="lastname">Lastname*</label>
                                <input type="text" id="lastname" onChange={e => setLastname(e.target.value)} name="lastname" value={lastname} />
                            </div>
                        </div>
                        ...
                        <div className="form-group" style={{ marginBottom: '0rem' }}>
                            ...
                            <textarea id="message" name="message" required onChange={e => setMessage(e.target.value)} defaultValue={message}></textarea>
                        </div>
                        <div>
