    ...
    render = () => {
        return (
            <nav>
                ...
                <div className="btn-open" onClick={this.openMenu}>
                ...
                <div className={ this.state.menuOpen ? "btn-close block" : "btn-close"} onClick = {this.closeMenu}>
            ...
            c7.4-7.4,19.5-7.4,26.9,0l0,0C353,178.8,353,190.9,345.6,198.3z" />
                ...
                <div className = { this.state.menuOpen ? "navbar-main w-80" : "navbar-main" }>
