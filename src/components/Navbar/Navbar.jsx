...
const Navbar = () => {
    ...
    return (
        <nav>
            ...
            <div className="btn-open" onClick={openMenu}>
            ...
            <div className={menuOpenState ? "btn-close block" : "btn-close"} onClick={closeMenu}>
            ...
            <div className={menuOpenState ? "navbar-main w-80" : "navbar-main"}>
